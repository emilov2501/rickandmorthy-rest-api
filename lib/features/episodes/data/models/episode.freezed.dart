...
class _$EpisodeModelImpl implements _EpisodeModel {
  const _$EpisodeModelImpl({this.imageUrl, this.name});
  ...
  @override
  String toString() {
    return 'EpisodeModel(imageUrl: $imageUrl, name: $name)';
  }
...
abstract class _EpisodeModel implements EpisodeModel {
  const factory _EpisodeModel({final String? imageUrl, final String? name}) =
      _$EpisodeModelImpl;
